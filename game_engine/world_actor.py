...
# --- ИЗМЕНЕНИЕ: импортируем новую функцию, убираем старые ---
from .core.export import write_client_chunk, write_chunk_preview, write_heightmap_r16, write_control_map_r32
