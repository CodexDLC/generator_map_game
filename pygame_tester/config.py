...
TILE_SIZE = 25  # Увеличили размер каждого тайла
VIEWPORT_WIDTH_TILES = 48  # Уменьшили количество тайлов по ширине
VIEWPORT_HEIGHT_TILES = 36 # Уменьшили количество тайлов по высоте
# --- КОНЕЦ ИЗМЕНЕНИЯ ---
