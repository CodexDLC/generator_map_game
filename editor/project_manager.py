...
class ProjectManagerDialog(QtWidgets.QDialog):
    ...
    def _ask_for_projects_directory(self):
        ...
        if directory:
            ...
            # Если пользователь отказался выбирать, даем ему еще один шанс или выходим
    ...
    def handle_new_project(self):
        # При создании нового проекта мы используем текущую папку проектов как базовую
    ...
    def handle_open_other(self):
        # Ручной выбор папки проекта, если его нет в списке
