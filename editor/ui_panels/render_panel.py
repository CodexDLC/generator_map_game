...
# ... (вспомогательная функция _create_spin_row остается без изменений)
...
class RenderPanel(QtWidgets.QWidget):
    ...
    def __init__(self, settings: RenderSettings, parent=None):
        ...
        # -- после блока пресетов, перед полями света --
    ...
    def _apply_preset(self):
        ...
        self.set_settings(new_settings) # Обновляем UI
        self._emit_changes() # Отправляем сигнал
    ...
    def _emit_changes(self):
        ...
        self.s.light_mode = self.mode.currentText() # НОВОЕ
        
        # Если настройки изменились вручную, сбрасываем пресет на "Custom"
    ...
    def set_settings(self, settings: RenderSettings):
        ...
        self.mode.setCurrentText(self.s.light_mode) # НОВОЕ
